...
export default function RequestPage() {
  ...
  <p className="mt-3 text-xs text-white/55">
    Rights-holders & publishers: if you own or represent a song and would like to discuss promotion, licensing, or any concerns, 
    please include your preferred contact details in the notes (or visit our Rights-holder page). We’ll respond promptly.
  </p>
  <a
     href="/rights-holder"
