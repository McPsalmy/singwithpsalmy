    ...
    <AdminGate>
      <main className="min-h-screen text-white">
        <section className="mx-auto max-w-4xl px-5 py-12">
          ...
          <p className="mt-2 text-sm text-white/65">Private management area.</p>
          ...
          <div className="mt-8 grid gap-4 md:grid-cols-2">
            ...
            <a
              ...
              className="rounded-3xl bg-white/5 p-6 ring-1 ring-white/10 hover:bg-white/10"
            >
              <div className="text-lg font-semibold">Account Delete Requests</div>
              <p className="mt-2 text-sm text-white/65">
                Review deletion requests submitted by users and mark them processed.
              </p>
            </a>
